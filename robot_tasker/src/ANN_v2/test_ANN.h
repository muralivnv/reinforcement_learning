...
void test_ann()
{
  std::string data_file = "X:/Video_Lectures/ReinforcementLearning/scripts/robot_tasker/scripts/analysis/ann_test_moon_data.csv";
  ...
  while(current_epoch < max_epoch)
  {
    ...
    network_opt.step(weight_grad, bias_grad, network.weights, network.bias);
